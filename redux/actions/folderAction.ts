...
export const updateSubFolder = (file: FileType) => (dispatch: Dispatch) => {
...
export const moveNode = (sourceId: IdType, targetId: IdType) => (dispatch: Dispatch) => {
  console.log("sourceId: ", sourceId, "targetId: ", targetId);
  dispatch(moveFolderFile({ sourceId, targetId }));
}

...
export function CustomeTreeView() {
  return (
    <SimpleTreeView
      aria-label="gmail"
    ...
    >
      <CustomTreeItem itemId="1" label="All Mail" labelIcon={FolderTwoTone} />
      <CustomTreeItem itemId="2" label="Trash" labelIcon={FolderTwoTone} />
      <CustomTreeItem itemId="3" label="Categories" labelIcon={FolderTwoTone}>
        <CustomTreeItem
          itemId="5"
          label="Social"
      ...
      <CustomTreeItem itemId="4" label="History" labelIcon={FolderTwoTone} />
    </SimpleTreeView>
  );
}
